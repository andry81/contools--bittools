...
namespace utility
{
        ...
        uint32_t xor_in, uint32_t xor_out, bool input_reflected, bool result_reflected)
    {
        ...
        case 16:
            ...
            case 0x0589: return _t_crc<uint16_t>(g_crc16_0589, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            case 0x3D65: return _t_crc<uint16_t>(g_crc16_3D65, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            case 0x8BB7: return _t_crc<uint16_t>(g_crc16_8BB7, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            case 0xA097: return _t_crc<uint16_t>(g_crc16_A097, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            }
            break;

        case 24:
            switch (polynomial) {
            case 0x864CFB: return _t_crc<uint32_t>(g_crc24_864CFB, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            case 0x5D6DCB: return _t_crc<uint32_t>(g_crc24_5D6DCB, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            }
            break;
        ...
        case 32:
            ...
            case 0x741B8CD7: return _t_crc<uint32_t>(g_crc32_741B8CD7, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            case 0x000000AF: return _t_crc<uint32_t>(g_crc32_000000AF, crc, buf, size, crc_init, xor_in, xor_out, input_reflected, result_reflected);
            }
            break;
        }
